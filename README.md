This is my solution to CS50 Web's Project 0, Google Search. 

The requirement of this project is to create a clone of Google's main page, including the search page, image search page, and advanced search page. Upon query, user will be redirected to the actual URL that contains the actual search result.

Here are the detailed specifications that the Project must meet:

1. The website should have at least three pages: one for regular Google Search (which must be called index.html), one for Google Image Search, and one for Google Advanced Search.
...
7. The CSS  should resemble Google’s own aesthetics.
